 ...
 *
 */
package net.mcreator.integratedmagic;
...
@Mod("integratedmagic")
public class IntegratedmagicMod {
	public static final Logger LOGGER = LogManager.getLogger(IntegratedmagicMod.class);
	public static final String MODID = "integratedmagic";
